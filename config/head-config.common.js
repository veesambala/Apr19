 ...
 *
 * { rel: 'apple-touch-icon', sizes: '57x57', href: '/assets/icon/apple-touch-icon-57x57.png', '=href': false },
...
module.exports = {
  ...
  script: [
    {type: 'text/javascript', src:'assets/js/ads.js'},
    {type: 'text/javascript', src:'https://imasdk.googleapis.com/js/sdkloader/ima3.js'},
    {type: 'text/javascript', src:'assets/js/moment.js'},
    {type: 'text/javascript', src:'assets/js/moment-timezone.js'},
    {type: 'text/javascript', src:'assets/js/banner-ad.js'}
  ]
};
